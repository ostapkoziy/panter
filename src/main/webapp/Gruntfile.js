...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        watch: {
            ...
            coffee: {
                files: ['<%= yeoman.app %>/scripts/{,*/}*.coffee', '<%= yeoman.app %>/scripts/{,*/*/}*.coffee', '<%= yeoman.app %>/scripts/{,*/*/*/}*.coffee'],
                tasks: ['coffee:dist']
            },
            coffeeTest: {
            ...
            handlebars: {
                files: [
                    '<%= yeoman.app %>/scripts/shared/*/*.hbs',
                    '<%= yeoman.app %>/scripts/modules/*/views/templates/*.hbs',
                    '<%= yeoman.app %>/scripts/screens/*/*.hbs',
                    '<%= yeoman.app %>/scripts/layouts/*/*.hbs'
                ],
                tasks: ['handlebars']
            },
            test: {
            ...
            dist: {
                ...
                options: {
                    ...
                    paths: {
                        ...
                        'foundation.tooltip': "../../app/bower_components/foundation/js/foundation/foundation.tooltip",
                        'backbone.validation': '../../app/bower_components/backbone-validation/dist/backbone-validation-amd',
                        'backbone.pageable': '../../app/bower_components/backbone-pageable/lib/backbone-pageable',
                        'backbone.controller': '../../app/scripts/vendor/backbone.controller',
                        'Mem': '../../app/scripts/vendor/mem',
